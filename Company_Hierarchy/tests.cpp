...
// my tests: 
TEST_CASE("lexicography Join") {

    const string loz_big =
        " Uspeshnia   -  Misho \n"
        " Uspeshnia   -  Bob \n"
        " Misho -  Pesho        \n"
        " Bob -  Toni        \n"
    ...
    Hierarchy l_new(loz_big);
    Hierarchy loz(large_new);

    Hierarchy joined = l_new.join(loz);
    INFO("take lexicography smaller manager in joined hierarchy");
    REQUIRE(joined.print() == "Uspeshnia-Bob\nUspeshnia-Misho\nBob-Pesho\nBob-Toni\nPesho-Koko\n");
    REQUIRE(joined.num_employees() == 6);
    REQUIRE(joined.longest_chain() == 4);
}

TEST_CASE("correct Join")
{
...
void createJoined(const Hierarchy& myTest1 , const Hierarchy& myTest2)
{
    Hierarchy tests = myTest1.join(myTest2);
}

TEST_CASE("incorrect Join")
{
    const string myTest1 =
        " Uspeshnia   -  Misho \n"
        " Uspeshnia   -  Bob \n"
    ...
    Hierarchy myH1(myTest1);
    Hierarchy myH2(myTest2);
    REQUIRE_THROWS(createJoined(myTest1 , myTest2));

    const string myTest3 =
        " Uspeshnia   -  Misho \n"
        " Uspeshnia   -  Bob \n"
        " Misho -  Pesho        \n"
        " Bob -  Toni        \n"
    ...
    Hierarchy myH3(myTest3);
    Hierarchy myH4(myTest4);
    REQUIRE_THROWS(createJoined(myTest3 , myTest4));
